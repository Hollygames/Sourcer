...
class MoveEvents : public BaseEvents
{
	public:
		...
		static bool EquipItem(MoveEvent* moveEvent, Player* player, Item* item, slots_t slot, bool isCheck, bool isLogin);
		static bool DeEquipItem(MoveEvent* moveEvent, Player* player, Item* item, slots_t slot, bool isRemoval, bool isLogout);
...
typedef bool (EquipFunction)(MoveEvent* moveEvent, Player* player, Item* item, slots_t slot, bool isCheck, bool isLogin);
