...
enum MagicEffect_t
{
	...
	MAGIC_EFFECT_DRAGONHEAD = 0x32C8,
	MAGIC_EFFECT_SEMFIM = 0x32C8, //65534
...
enum ShootEffect_t
{
	...
	SHOOT_EFFECT_CAKE = 0x32C8,
	SHOOT_EFFECT_SEMFIM        = 0x32C8, //65534
	SHOOT_EFFECT_LAST = SHOOT_EFFECT_CAKE,

	//for internal use, dont send to client
	SHOOT_EFFECT_WEAPONTYPE = 0xFFFE, //254
